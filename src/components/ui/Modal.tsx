    ...
    ? createPortal(
        ...
        >
          {children ? (
            <div
              ref={modalRef}
              className="bg-white rounded-md text-zinc-800 relative max-w-2xl w-full overflow-auto [&>*:nth-child(1)]:absolute [&>*:nth-child(1)]:top-4 [&>*:nth-child(1)]:right-4 mob:[&>*:nth-child(1)]:right-2 mob:[&>*:nth-child(1)]:top-2"
            >
