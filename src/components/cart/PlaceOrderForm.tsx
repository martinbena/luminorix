...
export default function PlaceOrderForm({ onStepDecrement, currentStep }: PlaceOrderForm) {
  ...
  return (
    <Form formAction={action} formRef={formRef}>
      ...
      <SetStepButtons onStepDecrement={onStepDecrement} currentStep={currentStep} />
    </Form>
  );
}
